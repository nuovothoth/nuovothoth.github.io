...
class App extends _react.default.Component {
  ...
  render() {
    ...
    }) : null, (0, _core.jsx)(_reactRouterDom.Route, {
      exact: true,
      path: "/collections/:name",
      render: props => {
        const collectionExists = collections.get(props.match.params.name);
        return collectionExists ? (0, _core.jsx)(_Collection.default, props) : (0, _core.jsx)(_reactRouterDom.Redirect, {
          to: defaultPath
        });
      }
